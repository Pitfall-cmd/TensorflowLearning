...
TRAIN_DATA_URL='file:///D:/PythonProject/Tensorflow2021_10_11/EmbeddingMLP/data/modelSamples.csv'
...
preprocessing_layer = tf.keras.layers.Dense(numerical_columns + categorical_columns)
